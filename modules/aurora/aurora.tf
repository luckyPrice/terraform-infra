resource "aws_rds_cluster" "rds-cluster" {
  cluster_identifier              = lower("aws-rds-cluster-dev-asw-aurora-aws-db")
...
resource "aws_rds_cluster_instance" "rds-instance" {
  ...
  identifier                  = lower("aws-rds-instance-dev-asw-aurora-asw-${count.index}")
...
resource "aws_rds_cluster_parameter_group" "rds-cluster-parameter-group" {
  name=lower("aws-rds-cluster-parameter-group-dev-asw-aurora-asw-db")
...
resource "aws_db_parameter_group" "rds-instance-parameter-group" {
  name        = lower("aws-rds-instance-parameter-group-dev-asw-aurora-asw6-db")
